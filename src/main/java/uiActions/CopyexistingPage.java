...
public class CopyexistingPage  extends testBase {
    ...
    public void copyexistingProdspecforms()  {
        ...
        // find the table
        WebElement table = driver.findElement(By.cssSelector("body > app-root > app-main > div > div > div.layout-main > div > app-home > div > p-dialog > div > div > div.ng-tns-c120-5.ui-dialog-content.ui-widget-content > p-treetable > div > div > table > tbody"));

        // find the row
        WebElement tablerow = table.findElement(By.cssSelector("body > app-root > app-main > div > div > div.layout-main > div > app-home > div > p-dialog > div > div > div.ng-tns-c120-5.ui-dialog-content.ui-widget-content > p-treetable > div > div > table > tbody > tr:nth-child(1)"));
